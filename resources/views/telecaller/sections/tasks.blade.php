...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .task-filters-row {
            ...
            box-shadow: 0 12px 26px rgba(6, 58, 28, 0.08) !important;
        }
        ...
        .task-filters-row .task-filter-select {
            ...
            border: 1.5px solid #d9e4dd !important;
    ...
    #postCallModal .modal-content {
        padding: 24px;
        border-radius: 20px;
        border: 1px solid rgba(217, 228, 221, 0.9);
        box-shadow: 0 24px 70px rgba(6, 58, 28, 0.24);
    }
    #postCallModal .modal-header {
        margin-bottom: 18px;
        padding-bottom: 14px;
        border-bottom: 1px solid #dce7e0;
    }
    #postCallModal .modal-header h3 {
        color: #063A1C;
        font-size: 22px;
        font-weight: 900;
        line-height: 1.2;
    }
    #postCallModal #postCallBody p {
        margin: 0 0 14px;
        color: #475569;
        font-size: 14px;
        font-weight: 700;
    }
    #postCallModal .outcome-buttons {
        gap: 10px;
        margin-top: 0;
    }
    #postCallModal .outcome-btn {
        min-height: 70px;
        padding: 12px 10px;
        border-radius: 14px;
        background: #ffffff;
    ...
    #postCallModal .outcome-btn i {
        width: 20px;
        font-size: 16px;
    }
    #telecallerOutcomeRemarkModal {
        z-index: 1003;
        background: rgba(15, 23, 42, 0.52);
        backdrop-filter: blur(2px);
    }
    #telecallerOutcomeRemarkModal .modal-content {
        padding: 24px;
        border-radius: 20px;
        border: 1px solid rgba(217, 228, 221, 0.9);
        box-shadow: 0 24px 70px rgba(6, 58, 28, 0.24);
    }
    #telecallerOutcomeRemarkModal .modal-header {
        margin-bottom: 16px;
        padding-bottom: 12px;
        border-bottom: 1px solid #dce7e0;
    }
    #telecallerOutcomeRemarkModal .modal-header h3 {
        color: #063A1C;
        font-size: 20px;
        font-weight: 900;
    }
    #telecallerOutcomeRemarkModal textarea {
        width: 100%;
        min-height: 110px;
        padding: 12px;
    ...
    #telecallerOutcomeRemarkModal .form-footer {
        display: grid;
        grid-template-columns: 1fr 1fr;
        gap: 10px;
        margin-top: 16px;
    }
    #telecallerOutcomeRemarkModal .btn-cancel,
    #telecallerOutcomeRemarkModal .btn-save {
        min-height: 46px;
        border-radius: 12px;
        font-weight: 900;
    ...
    @media (max-width: 768px) {
        ...
        #tasksContent.tasks-grid,
        #tasksContent.tasks-list {
            display: block !important;
            margin-top: 0 !important;
        }
        #tasksContent .empty-state,
        #tasksContent .loading-state {
            ...
            background: #ffffff !important;
            box-shadow: 0 14px 30px rgba(6, 58, 28, 0.08) !important;
        }
        #postCallModal {
        ...
        let formHTML = `
            <form id="leadRequirementForm" onsubmit="submitLeadRequirementForm(event); return false;">
                ...
                <div class="lead-form-section">
                    <h3 class="lead-form-section-title">Basic Information</h3>
                ...
                <div class="lead-form-section">
                    <h3 class="lead-form-section-title">Lead Requirements</h3>
                    <div class="lead-form-grid">
        `;
        ...
        formHTML += `
                ...
                <div class="lead-form-actions">
                    <button type="button" 
                            ...
                            class="lead-form-cancel-btn">
                        Cancel
                    </button>
                    <button type="submit" 
                            class="lead-form-submit-btn">
