...
<div class="page">
    <div class="shell">
        <aside class="sidebar">
            <div class="brand">
                <strong>Project Public Page</strong>
                <span>Share-only customer page wizard</span>
            </div>
            <div class="steps">
                @foreach ([1 => 'Basic Info', 2 => 'Hero & Public Content', 3 => 'Units & Pricing', 4 => 'Media & Downloads', 5 => 'Location', 6 => 'CTA & Publish'] as $index => $label)
        ...
        <main class="panel">
            <div class="toolbar">
                <div>
                    <h1>{{ $project ? 'Edit Public Page' : 'Create Public Page' }}</h1>
                    <p>Wizard stays separate from the current project form and saves public-page specific data only.</p>
                </div>
                <div class="badge-row">
            ...
            <form id="public-page-form" method="POST" action="{{ route('projects.public-pages.save') }}" enctype="multipart/form-data">
                ...
                <section class="wizard-step {{ $currentStep === 1 ? 'active' : '' }}" data-step="1">
                    ...
                    <p class="section-note">Reuse core project data from the existing module and keep this page focused on customer-share essentials.</p>
                    <div class="grid">
                        <div class="field">
                            <label>Builder</label>
                ...
                <section class="wizard-step {{ $currentStep === 2 ? 'active' : '' }}" data-step="2">
                    <h2 class="section-title">Hero & Public Content</h2>
                    <p class="section-note">Keep the content sharp and minimal. This is the first thing the customer sees.</p>
                    <div class="grid">
                        <div class="field">
                ...
                <section class="wizard-step {{ $currentStep === 3 ? 'active' : '' }}" data-step="3">
                    <h2 class="section-title">Units & Pricing</h2>
                    <p class="section-note">Size variants are the main sellable rows. Every visible variant should be customer-ready.</p>
                    <div class="grid-3">
                        <div class="field">
                ...
                <section class="wizard-step {{ $currentStep === 4 ? 'active' : '' }}" data-step="4">
                    ...
                    <p class="section-note">Only project-level media lives here. Variant PDFs stay in the units section.</p>
                    <div id="assets-root">
                ...
                <section class="wizard-step {{ $currentStep === 5 ? 'active' : '' }}" data-step="5">
                    ...
                    <p class="section-note">Existing map and landmark section stays. Travel time widget uses project coordinates and optional quick origins.</p>
                    <div class="grid">
                        <div class="field">
                ...
                <section class="wizard-step {{ $currentStep === 6 ? 'active' : '' }}" data-step="6">
                    <h2 class="section-title">CTA & Publish</h2>
                    <p class="section-note">Customer page stays share-only. Publish only when CTAs and variant PDFs are ready.</p>
                    <div class="grid">
                        <div class="field">
                    ...
                    @if($project && $shareLink)
                        <div class="actions" style="margin-top:18px;">
                            <a class="btn btn-secondary" href="{{ route('projects.public-pages.preview', $project) }}" target="_blank">Preview as Customer</a>
                ...
                <div class="footer-actions">
                    <div class="actions">
                        <button type="button" class="btn btn-secondary" id="save-draft">Save</button>
                        <button type="button" class="btn btn-primary" id="publish-page-button">Save & Publish</button>
                    </div>
                </div>
            </form>
        </main>
