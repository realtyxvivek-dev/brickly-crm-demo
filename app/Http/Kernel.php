...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\CheckMaintenanceMode::class,
            \App\Http\Middleware\GuardReopenedLeadActivities::class,
            \App\Http\Middleware\MaskCustomerPhoneResponses::class,
        ],
    ...
    protected $middlewareAliases = [
        ...
        'relief.block' => \App\Http\Middleware\BlockHeavyRoutesDuringReliefMode::class,
    ];
}
